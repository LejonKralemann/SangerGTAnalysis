...
plt
ggsave(file=paste0(output_dir, "main_stackedbar.png"), plot=plt, width=9, height=4)
...
plt
ggsave(file=paste0(output_dir, "main_stackedbar_sup.png"), plot=plt, width=8, height=4)
